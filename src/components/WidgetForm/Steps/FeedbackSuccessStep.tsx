    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <span className="text-xl mt-2 py-3">Agradecemos o feedback!</span>

                <button
                    onClick={onFeedbackRestartRequested}
                    className="py-4 px-6 bg-[#131313] rounded-md border-transparent text-sm leading-6 hover:bg-[#242424] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#191919] focus:ring-brand-500"
                >
                    Quero enviar outro
                </button>
            </div>
